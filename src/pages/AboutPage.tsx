...
const team = [
  { name: 'Людмила Айзеншпис', role: 'Генеральный директор, «Мидэкспо»' },
  { name: 'Сергей Куприянов', role: 'Директор по развитию' },
  { name: 'Анна Воронова', role: 'Руководитель по работе с участниками' },
  { name: 'Дмитрий Лебедев', role: 'PR и медиа' },
];
