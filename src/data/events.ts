...
export const events: Event[] = [
  ...
  },
  {
    ...
    venue: 'Отель Экспресс Садовая',
    dates: '20–21 марта 2027',
    dateFrom: new Date('2027-03-20'),
    dateTo: new Date('2027-03-21'),
    address: 'Санкт-Петербург, Садовая ул., 62',
    ...
    about: {
      description: 'Петербургская выставка отличается особой атмосферой: исторический центр города и уютные залы отеля Экспресс Садовая создают идеальный фон для прослушивания музыки высокого класса. Камерный формат позволяет уделить каждому гостю максимум внимания.',
      highlights: [
  ...
  },
  {
    ...
    venue: 'Отель «Московская горка»',
    dates: '22–23 мая 2027',
    dateFrom: new Date('2027-05-22'),
    dateTo: new Date('2027-05-23'),
    address: 'Екатеринбург, ул. Московская, 131',
    ...
    about: {
      description: 'Екатеринбург — первый уральский город в истории HI FI SHOW. Столица Урала с её богатой промышленной и культурной историей становится новой точкой на карте российского аудиофильства. Отель «Московская горка» обеспечит идеальные условия для демонстрации техники.',
      highlights: [
